...
const usuariosDisponibles = computed(() => {
  ...
  return usuarios.value.filter(u => {
    const esTrab = u.id_usuario.startsWith('trab_m')
...
function cargarUsuarios () {
  axios
    .get('propietario/melamina/usuarios')
    .then(res => {
...
function guardar () {
  ...
  const url = editando.value
    ? `propietario/melamina/trabajadores/${idEditar.value}`
    : 'propietario/melamina/trabajadores'
...
function eliminar (id) {
  ...
  axios
    .delete(`propietario/melamina/trabajadores/${id}`)
    .then(() => {
      buscarTrabajadores()
...
function buscarTrabajadores () {
  axios
    .get('propietario/melamina/trabajadores', {
