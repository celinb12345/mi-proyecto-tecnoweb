...
async function loadPersonas () {
  ...
  try {
    const { data } = await axios.get('propietario/melamina/dashboard/resumen-personas')
    personas.value = data
    buildPersonasChart()
  } catch (e) {
...
async function loadInventario () {
  ...
  try {
    const { data } = await axios.get('propietario/melamina/dashboard/inventario-mensual')
    inventario.value = {
      labels: data.labels || [],
...
async function loadPagos () {
  ...
  try {
    const { data } = await axios.get('propietario/melamina/dashboard/pagos-pendientes')
    pagos.value = {
      labels: data.labels || [],
      montos: data.montos || [],
...
async function loadCuotas () {
  ...
  try {
    const { data } = await axios.get('propietario/melamina/dashboard/cuotas-pendientes')
    cuotas.value = {
      labels: data.labels || [],
...
async function loadProyectos () {
  ...
  try {
    const { data } = await axios.get('propietario/melamina/dashboard/proyectos-contador')
    proyectos.value = {
      labels: data.labels || [],
...
async function loadProyectosPagos () {
  ...
  try {
    const { data } = await axios.get('propietario/melamina/dashboard/proyectos-pagos-clientes')
