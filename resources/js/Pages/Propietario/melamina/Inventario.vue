...
function cargarInventario(params = {}) {
  return axios
    .get('propietario/melamina/inventario', { params })
    .then((res) => {
...
function guardarInventario() {
  ...
  const url = editandoInv.value
    ? `propietario/melamina/inventario/${idEditarInv.value}`
    : 'propietario/melamina/inventario'
...
function eliminarInventario(id) {
  ...
  axios
    .delete(`propietario/melamina/inventario/${id}`)
    .then(() => {
...
function cargarUnidades(params = {}) {
  return axios
    .get('propietario/melamina/unidad-medida', { params })
    .then((res) => {
      unidades.value = res.data.unidades || []
    })
    .catch((err) => {
...
function guardarUnidad() {
  ...
  const url = editandoUni.value
    ? `propietario/melamina/unidad-medida/${idEditarUni.value}`
    : 'propietario/melamina/unidad-medida'
...
function eliminarUnidad(id) {
  ...
  axios
    .delete(`propietario/melamina/unidad-medida/${id}`)
    .then(() => {
