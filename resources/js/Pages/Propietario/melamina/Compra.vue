...
function cargarDatos (params = {}) {
  return axios
    .get('propietario/melamina/compras', { params })
    .then(res => {
...
function guardar () {
  ...
  const url = editando.value
    ? `propietario/melamina/compras/${idEditar.value}`
    : 'propietario/melamina/compras'
...
function eliminar (id) {
  ...
  axios
    .delete(`propietario/melamina/compras/${id}`)
    .then(() => {
...
function cargarProductos () {
  return axios
    .get('propietario/melamina/productos')
    .then(res => {
...
function cargarDetalles (idCompra) {
  return axios
    .get(`propietario/melamina/compras/${idCompra}/detalles`)
    .then(res => {
...
async function agregarDetalle () {
  ...
  try {
    const { data } = await axios.post(
      'propietario/melamina/compras/detalles',
      payload
    )
