...
async function reverseGeocode (lat, lon) {
  try {
    ...
    const { data } = await axios.get(url, {
      withCredentials: false,          // 👈 lo mismo aquí
      headers: {
        'Accept-Language': 'es'
      }
    })
...
function cargarProyectos (params = {}) {
  return axios
    .get('propietario/Construccion/proyectos', { params })
    .then((res) => {
...
function guardarProyecto () {
  ...
  const url = editandoProy.value
    ? `propietario/Construccion/proyectos/${idEditarProy.value}`
    : 'propietario/Construccion/proyectos'
...
function eliminarProyecto (id) {
  ...
  axios
    .delete(`propietario/Construccion/proyectos/${id}`)
    .then(() => {
...
function cargarAsignaciones () {
  return axios
    .get('propietario/Construccion/asignaciones')
    .then((res) => {
...
function guardarAsignacion () {
  ...
  const url = editandoAsig.value
    ? `propietario/Construccion/asignaciones/${idEditarAsig.value}`
    : 'propietario/Construccion/asignaciones'
...
function eliminarAsignacion (id) {
  ...
  axios
    .delete(`propietario/Construccion/asignaciones/${id}`)
    .then(() => {
