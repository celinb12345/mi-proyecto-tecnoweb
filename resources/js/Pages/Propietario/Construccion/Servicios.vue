...
function cargarServicios (params = {}) {
  return axios
    .get('propietario/Construccion/servicios', { params })
    .then((res) => {
...
function guardarServicio () {
  const url = editandoServ.value
    ? `propietario/Construccion/servicios/${idEditarServ.value}`
    : 'propietario/Construccion/servicios'
...
function eliminarServicio (id) {
  ...
  axios
    .delete(`propietario/Construccion/servicios/${id}`)
    .then(() => {
...
function cargarDetalle () {
  return axios
    .get('propietario/Construccion/proyecto-servicios')
    .then((res) => {
...
function guardarDetalle () {
  const url = editandoDet.value
    ? `propietario/Construccion/proyecto-servicios/${idEditarDet.value}`
    : 'propietario/Construccion/proyecto-servicios'
...
function eliminarDetalle (id) {
  ...
  axios
    .delete(`propietario/Construccion/proyecto-servicios/${id}`)
    .then(() => {
