...
const usuariosDisponibles = computed(() => {
  ...
  return usuarios.value.filter(u => {
    const esProveedor = u.id_usuario.startsWith('prov_c')
...
async function guardar () {
  ...
  const url = editando.value
    ? `propietario/Construccion/proveedores/${idEditar.value}`
    : 'propietario/Construccion/proveedores'
...
function eliminar (id) {
  ...
  axios
    .delete(`propietario/Construccion/proveedores/${id}`)
    .then((res) => {
...
function buscarProveedores () {
  axios
    .get('propietario/Construccion/proveedores', { params: { buscar: buscar.value } })
    .then((res) => {
