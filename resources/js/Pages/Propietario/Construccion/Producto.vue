...
function listarProductos() {
  ...
  axios
    .get('propietario/Construccion/productos', { params })
    .then((res) => {
...
function guardarProducto() {
  ...
  const url = editandoProd.value
    ? `propietario/Construccion/productos/${idProdEditar.value}`
    : 'propietario/Construccion/productos'
...
function eliminarProducto(id) {
  ...
  axios
    .delete(`propietario/Construccion/productos/${id}`)
    .then(() => {
...
function guardarCategoria() {
  ...
  const url = editandoCat.value
    ? `propietario/Construccion/categorias/${idCatEditar.value}`
    : 'propietario/Construccion/categorias'
...
function eliminarCategoria(id) {
  ...
  axios
    .delete(`propietario/Construccion/categorias/${id}`)
    .then(() => {
